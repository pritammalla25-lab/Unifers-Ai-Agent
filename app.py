...
st.markdown(
    ...
    .brand img { width:38px; height:38px; object-fit:contain; border:1px solid #e3e8ef; border-radius:11px; padding:6px; background:white; }
    ...
    .hero img { width:68px; height:68px; object-fit:contain; padding:10px; border-radius:20px; background:#fff; border:1px solid #e0e6ee; box-shadow:0 12px 34px rgba(15,23,42,.08); }
